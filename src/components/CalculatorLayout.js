    ...
    <div className={"max-w-screen-sm mx-auto mt-4"}>
      <div className="flex">
        ...
        <div className="flex grow justify-end">
          <button className="flex justify-end items-center group text-2xl px-3 py-1 mx-1 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-800 disabled:bg-slate-200 dark:disabled:bg-slate-800 text-slate-900 dark:text-slate-50 rounded-t-xl" onClick={() => setDarkMode(!darkMode)}>
